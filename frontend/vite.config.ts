...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? 'WMS';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? 'Warehouse Management System';
